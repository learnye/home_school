...
<script>
    var modleName = '${ctxPath}/userTeacher';
    ...
    function initData() {
        ...
        loadOptionList({
            ...
            selectedValue: currentItemData.classroomid
        });
        $("input:radio[name='gender'][value='" + currentItemData.gender + "']").attr('checked', 'checked');
        //绑定图片上传的内容(规则就是按你的id名字一定要和图片容器的class名字一样)并回显
